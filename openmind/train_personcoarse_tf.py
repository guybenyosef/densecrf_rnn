...
from deeplabv2_model_personcoarse import Model_msc
...
def configure():
    ...
    flags.DEFINE_integer('save_interval', 500, 'number of iterations for saving and visualization')
    ...
    flags.DEFINE_string('pretrain_file', '/om2/user/cfmata/Deeplab-v2--ResNet-101--Tensorflow/model_personcoarse/model.ckpt-16000', 'pre-trained model filename corresponding to encoder_name')
    flags.DEFINE_string('data_list', './lst/pascal_parts_lists_horse_cow_person/person_train.txt', 'training data list filename')
    ...
    flags.DEFINE_string('valid_data_list', './lst/pascal_parts_lists_horse_cow_person/person_test.txt', 'validation data list filename')
    ...
    flags.DEFINE_string('test_data_list', './lst/pascal_parts_lists_horse_cow_person/person_test.txt', 'testing/validation data list filename')
    flags.DEFINE_boolean('visual', True, 'whether to save predictions for visualization')

    # data
    flags.DEFINE_string('data_dir', '/om2/user/cfmata/crfasrnn_keras/data/person_coarse_parts', 'data directory')
    ...
    # log
    flags.DEFINE_string('modeldir', 'model_personcoarse_crf_ft500', 'model directory')
