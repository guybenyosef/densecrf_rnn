...
from deeplabv2_model_personfine import Model_msc
...
def configure():
    ...
    flags.DEFINE_string('pretrain_file', '/om2/user/cfmata/Deeplab-v2--ResNet-101--Tensorflow/model_personfine/model.ckpt-17000', 'pre-trained model filename corresponding to encoder_name')
    ...
    # log
    flags.DEFINE_string('modeldir', 'model_personfine_crf', 'model directory')
