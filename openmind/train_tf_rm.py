...
def configure():
	...
	# training
	flags.DEFINE_integer('num_steps', 100, 'maximum number of iterations')
	flags.DEFINE_integer('save_interval', 5, 'number of iterations for saving and visualization')
	...
	flags.DEFINE_string('pretrain_file', 'model_multigpu_bs10/model.ckpt-20000.data-00000-of-00001', 'pre-trained model filename corresponding to encoder_name')
	...
	# validation
	flags.DEFINE_integer('valid_step', 100, 'checkpoint number for validation')
	...
	flags.DEFINE_integer('test_step', 100, 'checkpoint number for testing/validation')
	...
	# log
	flags.DEFINE_string('modeldir', 'model_crf', 'model directory')
