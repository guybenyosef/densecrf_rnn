...
if __name__ == '__main__':
    ...
    if args.dataset == "horsecoarse" or args.dataset == "horsecoarse_small":
        RES_DIR = "results/horse_coarse/"
        nb_classes = 6
    elif args.dataset == "horsefine":
        RES_DIR = "results/horse_fine/"
        nb_classes = 22
    elif args.dataset == "personcoarse":
        RES_DIR = "results/person_coarse/"
        nb_classes = 7
    elif args.dataset == "personfine":
        RES_DIR = "results/person_fine/"
        nb_classes = 25
    elif args.dataset == "voc2012":
        RES_DIR = "results/pascal_voc12/"
        nb_classes = 21
    else:
        RES_DIR = ""
        nb_classes = 21
    ...
    checkpoint = ModelCheckpoint(RES_DIR+"horse_freeze160_start80_SP_ckpt.{epoch:02d}-{val_loss:.2f}", save_weights_only=True,verbose=1, period=20)
    cb_list = [checkpoint]
