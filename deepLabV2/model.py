...
class Model(object):
    ...
    def test(self):
        ...
        #checkpointfile = './model/model.ckpt-20000.data-00000-of-00001'
        checkpointfile = tf.train.latest_checkpoint("./model/")
        ...
        print("valid num steps ", self.conf.valid_num_steps)
    ...
    def predict(self):
        ...
        # load checkpoint
        #checkpointfile = self.conf.modeldir+ '/model.ckpt-' + str(self.conf.valid_step)
        #checkpointfile = 'resnet_v1_101.ckpt'
