...
class Model_msc(object):
    ...
    def test(self):
        ...
        #checkpointfile = tf.train.latest_checkpoint("./model_personcoarse/")
        checkpointfile = './model_personcoarse/model.ckpt-17000'
    ...
    def predict(self):
        ...
        #checkpointfile = self.conf.modeldir+ '/model.ckpt-' + str(self.conf.valid_step)
        #checkpointfile = 'deeplab_resnet_init.ckpt'
        checkpointfile = tf.train.latest_checkpoint("./model_multigpu_test10_init/")
        self.load(self.loader, checkpointfile)
            ...
            with tf.device(gpu_list[i]):
                ...
                with tf.name_scope("create_inputs"):
                    reader = ImageReader(
                        ...
                        IMG_MEAN,
                        self.coord)
                    self.image_batch, self.label_batch, names = reader.dequeue(self.conf.batch_size)
