...
def configure():
    ...
    flags.DEFINE_integer('save_interval', 50000, 'number of iterations for saving and visualization')
    ...
    flags.DEFINE_string('pretrain_file', 'deeplab_resnet.ckpt', 'pre-trained model filename corresponding to encoder_name')
    flags.DEFINE_string('data_list', './dataset/voc2012_train.txt', 'training data list filename')
    ...
    flags.DEFINE_string('valid_data_list', './dataset/voc2012_val.txt', 'validation data list filename')
    ...
    flags.DEFINE_string('test_data_list', './dataset/voc2012_val.txt', 'testing/validation data list filename')
