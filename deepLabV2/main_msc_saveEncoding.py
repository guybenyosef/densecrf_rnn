...
from model_saveEncoding import Model_msc
...
def configure():
	...
	flags.DEFINE_string('data_list', './dataset/val_encoding.txt', 'training data list filename')
	...
	# log
	flags.DEFINE_string('modeldir', 'model_multigpu', 'model directory')
