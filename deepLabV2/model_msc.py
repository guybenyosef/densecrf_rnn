...
class Model_msc(object):
    ...
    def train(self):
        ...
        if self.conf.pretrain_file is not None:
            #checkpoint_file = './model_msc_restart43000'+ '/model.ckpt-' + '14000'
        ...
        for step in range(self.conf.num_steps+1):
            ...
            feed_dict = { self.curr_step : step} # change step here if restarting
            loss_value = 0
    ...
    def test(self):
        ...
        # load checkpoint
        #checkpointfile = self.conf.modeldir+ '/model.ckpt-' + '15000' #str(self.conf.valid_step)
