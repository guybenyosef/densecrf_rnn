...
from utils_gby import IoU_ver2,give_color_to_seg_img,visualize_conv_filters, compute_median_frequency_reweighting, load_segmentations, load_RAG_segmentations
...
def argument_parser():
    ...
    parser.add_argument('-sp', '--superpixel', default=0, help='Specify whether to use superpixel potential', type=int)
