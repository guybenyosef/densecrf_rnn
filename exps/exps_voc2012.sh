...
python train_gby.py -m fcn_RESNET50_8s -is 224 -ds voc2012 -e $num_ep -bs 32 -g $gpu_num
...
python train_gby.py -m fcn_RESNET50_8s_crfrnnSP -is 512 -ds horsecoarsedbg -e 2 -bs 1 -g 0 -vb 1
python train_gby.py -m fcn_RESNET50_8s_crfrnn -is 512 -ds horsecoarsedbg -e 2 -bs 1 -g 0 -vb 1